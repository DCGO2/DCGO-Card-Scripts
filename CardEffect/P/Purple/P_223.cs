...
namespace DCGO.CardEffects.P
{
    ...
    public class P_223 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            {
                return "[On Play] [When Digivolving] You may use 1 [Onmyōjutsu] or [Plug-In] trait Option card from your hand or trash without paying the cost.";
            }
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpActivateClass(SharedCanActivateCondition, SharedActivateCoroutine, -1, true, SharedEffectDiscription());
                cardEffects.Add(activateClass);
            ...
            if (timing == EffectTiming.OnUseOption)
            {
                ...
                string EffectDiscription()
                {
                    return "[All Turns][Once Per Turn] When you use Option cards, play 1 [Pipe Fox] Token (Digimon/Yellow/6000 DP/<Blocker>).";
                }
