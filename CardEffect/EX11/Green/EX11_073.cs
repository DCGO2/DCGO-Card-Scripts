    ...
    public class EX11_073 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEndTurn)
            {
                ...
                bool OpponentsDigimonCondition(Permanent permanent) => CardEffectCommons.IsPermanentExistsOnOpponentBattleAreaDigimon(permanent);

                IEnumerator ActivateCondition(Hashtable hashtable)
                {
                    ...
                    int maxCount = Math.min(effectCount, CardEffectCommons.MatchConditionOpponentsPermanentCount(OpponentsDigimonCondition));
