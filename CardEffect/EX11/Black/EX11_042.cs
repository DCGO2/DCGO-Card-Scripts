...
namespace DCGO.CardEffects.EX11
{
    public class EX11_042 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            #region Shared OP / WD
            string SharedEffectName = "Play [Maquinamon] from hand or Link cards for free.";
            ...
            IEnumerator SharedActivateCoroutine(Hashtable hashtable, ActivateClass activateClass)
            {
                ...
                bool validLinkCard = card.PermanentOfThisCard().DigivolutionCards.Some(IsLinkableMaquiIsMaquinamonCardnamonCard);
