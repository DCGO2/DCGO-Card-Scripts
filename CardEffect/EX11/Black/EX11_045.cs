...
namespace DCGO.CardEffects.EX11
{
    public class EX11_045 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            {
                if (CardEffectCommons.HasMatchConditionOpponentsPermanent(OpponentsDigimonCondition))
                {
                ...
                if (CardEffectCommons.HasMatchConditionOpponentsPermanent(CannotUnsuspendValidTargets))
                {
                    SelectPermanentEffect selectPermanentEffect = GManager.instance.GetComponent<SelectPermanentEffect>();
